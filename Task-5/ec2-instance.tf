...
resource "null_resource" "my_skills" {
  connection{
    type = "ssh"
    user = "ec2-user"
    private_key = file("C:/Users/karan.maheshwari/Downloads/terraform.pem")
  ...
  provisioner "remote-exec" {
    inline = [
		...
		"sudo wget https://github.com/mkaran15/skill-test/archive/refs/heads/main.zip",
		"sudo unzip main.zip",
		"sudo mv skill-test-main/index.html /var/www/html/",
		"sudo setenforce 0",
